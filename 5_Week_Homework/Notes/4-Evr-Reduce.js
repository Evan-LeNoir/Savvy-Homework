...
let sumOf200 = arrayOfNumbers(200).reduce((sum, num) => sum + num, 0); // can initialize the value or total or leave it blank in this example.
console.log(sumOf200);
...
const taskTallys = tasks.reduce((acc, curr) => {
...
const usersTaskSummary = tasks.reduce((acc, curr) => {
  if (acc[curr.userId]) {
